    ...
    <section className="w-full bg-white py-12 sm:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          <h2 className="text-3xl sm:text-4xl font-semibold text-black tracking-wide">Women</h2>
          <p className="mt-2 text-xs sm:text-sm text-[#5f5f5f]">
            Discover your signature fragrance from our exclusive collection for Women
          </p>
          <Link
            to="/category/women"
