...
const ProductPage = () => {
  ...
  const openEdit = (product) => {
    ...
    setEditForm({
      ...
      freeDelivery: Boolean(product.services?.freeDelivery ?? product.freeDelivery),
      isReturnable: (product.shippingAndReturns?.returns?.isReturnable ?? product.isReturnable) !== false,
