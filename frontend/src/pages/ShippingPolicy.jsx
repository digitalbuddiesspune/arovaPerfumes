...
const sections = [
  {
    ...
    lines: [
      ...
      'Delivery takes 3-7 business days across India.',
    ],
  },
  {
    title: '2. Shipping Charges',
    lines: ['Free shipping on orders above ₹999.', 'Standard shipping charges apply below that.'],
  },
  {
    title: '3. Order Tracking',
    lines: ['Tracking details will be shared via email/SMS after dispatch.'],
  },
  {
    title: '4. Delays',
    lines: [
      'Delivery may be delayed due to unforeseen circumstances (weather, logistics issues).',
    ],
  },
];
